        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/ban-quyen/update" method="post">
                        <div class="row">
                            <input type="hidden" class="form-control" name="id" value="${detail.idBanQuyen}"/>
                            <div class="col-12">
                                <label>Tên Sách</label>
                                <br>
                                <select name="tenSach">
                                    <c:forEach items="${listS}" var="l">
                                        <option value="${l.idSach}" ${detail.sach.idSach==l.idSach?"selected":""} >${l.tieuDe}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="maGiayPhep">
                                    <c:forEach items="${listGP}" var="l">
                                        <option value="${l.idGiayPhep}" ${detail.giayPhep.idGiayPhep==l.idGiayPhep?"selected":""}>GP${l.idGiayPhep}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="nguoiKy" value="${detail.nguoiKy}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Ngày Bắt Đầu</label>
                                <input type="date" class="form-control" name="ngayBatdau" value="${detail.ngayBatdau}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
