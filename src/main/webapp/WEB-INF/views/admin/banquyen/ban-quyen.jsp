                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/admin/ban-quyen/add" method="post">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <select name="tenSach">
                                                        <c:forEach items="${listS}" var="l">
                                                            <option value="${l.idSach}">${l.tieuDe}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <br>
                                                    <select name="maGiayPhep">
                                                        <c:forEach items="${listGP}" var="l">
                                                            <option value="${l.idGiayPhep}">GP${l.idGiayPhep}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                    ...
                    <div class="table-responsive mt-5" style="overflow-x: auto">
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${ list }" var="l">
                                <tr>
                                    <td>BQ${l.idBanQuyen}</td>
                                    <td>${l.sach.tieuDe}</td>
                                    <td>${l.nguoiKy}</td>
                                    <td>GP${l.giayPhep.idGiayPhep}</td>
                                    <td>${l.ngayBatdau}</td>
                                    <td>${l.ngayHetHan}</td>
                                    <td>${l.trangThai==0?"Hết Hạn":"Còn"}</td>
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalUpdate_${l.idBanQuyen}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button> <!-- Modal update -->
                                        <div class="modal fade" id="modalUpdate_${l.idBanQuyen}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/ban-quyen/viewUpdate?id=${l.idBanQuyen}"
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDelte_${l.idBanQuyen}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button> <!-- Modal delete -->
                                        <div class="modal fade" id="modalDelte_${l.idBanQuyen}"
                                             data-bs-backdrop="static" data-bs-keyboard="false"
                                             tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/ban-quyen/delete?id=${l.idBanQuyen}"
