    ...
    <div class="row">
        <div class="col-2 p-4 shadow"
            ...
            <div class="list-group">
               ...
               <a href="/admin/the-loai/hien-thi"
                        class="list-group-item list-group-item-action border-0 "
                        style="background-color: #0a3d62; color: #dcdde1"> <span><i
                                        ...
                                        <form action="/admin/voucher/add" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="number" class="form-control" name="soGiayPhep"/>
                                                </div>
                                            </div>
                    ...
                    <div class="table-responsive mt-5" style="overflow-x: auto">
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${ list }" var="l">
                                <tr>
                                    <td>VC${l.idVoucher}</td>
                                    <td>${l.giaTriGiam}</td>
                                    <td>${l.ngayHetHan}</td>
                                    <td>${l.soLuong}</td>
                                    <td>${l.trangThai==0?"Không Còn Sử Dụng Được":"Còn Sử Dụng Được"}</td>
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalUpdate_${l.idVoucher}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button> <!-- Modal update -->
                                        <div class="modal fade" id="modalUpdate_${l.idVoucher}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/voucher/viewUpdate?id=${l.idVoucher}"
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDelte_${l.idVoucher}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button> <!-- Modal delete -->
                                        <div class="modal fade" id="modalDelte_${l.idVoucher}"
                                             data-bs-backdrop="static" data-bs-keyboard="false"
                                             tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/voucher/delete?id=${l.idVoucher}"
