            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/voucher/update" method="post">
                        <input type="hidden" class="form-control" name="id" value="${detail.idVoucher}"/>
                        <div class="row">
                            <div class="col-12">
                                <label>Giá Trị Giảm</label>
                                <input type="number" class="form-control" name="giaTriGiam" value="${detail.giaTriGiam}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="number" class="form-control" name="soGiayPhep" value="${detail.soLuong}"/>
                            </div>
                        </div>
