        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/nhan-vien/update" method="post">
                        <input type="hidden" class="form-control" name="id" value="${detail.idNhanVien}"/>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="radio" value="Nam"   ${detail.gioiTinh=="Nam"?"checked":""} name="gioiTinh" checked="checked"/> Nam
                                <input type="radio" value="Nữ"  ${detail.gioiTinh=="Nữ"?"checked":""} name="gioiTinh"/> Nữ
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="radio"  value="0"  ${detail.trangThai==0?"checked":""} name="trangThai"  checked="checked"/> Đã Nghỉ
                                <input type="radio"  value="1"   ${detail.trangThai==1?"checked":""} name="trangThai"/> Còn Làm
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
