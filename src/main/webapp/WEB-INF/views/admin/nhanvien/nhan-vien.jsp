                                        ...
                                        <form action="/admin/nhan-vien/add" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="radio" value="Nam" name="gioiTinh" checked="checked"/> Nam
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="radio"  value="0" name="trangThai" checked="checked"/> Còn Làm
                                                    <input type="radio"  value="1" name="trangThai"/> Đã Nghỉ
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${ list }" var="l">
                                <tr>
                                    ...
                                    <td>${l.ngaySinh}</td>
                                    <td>${l.diaChi}</td>
                                    <td>${l.trangThai==0?"Đã Nghỉ":"Còn Làm"}</td>
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalUpdate_${l.idNhanVien}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button> <!-- Modal update -->
                                        <div class="modal fade" id="modalUpdate_${l.idNhanVien}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/nhan-vien/viewUpdate?id=${l.idNhanVien}"
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDelte_${l.idNhanVien}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button> <!-- Modal delete -->
                                        <div class="modal fade" id="modalDelte_${l.idNhanVien}"
                                             data-bs-backdrop="static" data-bs-keyboard="false"
                                             tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/nhan-vien/delete?id=${l.idNhanVien}"
