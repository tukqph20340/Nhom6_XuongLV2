                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/admin/nha-xuat-ban/add" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="radio"   value="0" name="trangThai" checked="checked"/>Ngưng Hoạt Động
                                                    <input type="radio"   value="1" name="trangThai" />Vẫn Còn Hoạt Động
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                    ...
                    <div class="table-responsive mt-5" style="overflow-x: auto">
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${ list }" var="l">
                                <tr>
                                    <td>NXB${l.idNhaXuatBan}</td>
                                    <td>${l.ten}</td>
                                    <td>${l.diaChi}</td>
                                    <td>${l.sdt}</td>
                                    <td>${l.trangThai==0?"Ngưng Hoạt Động":"Vẫn Còn Hoạt Động"}</td>
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalUpdate_${l.idNhaXuatBan}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button> <!-- Modal update -->
                                        <div class="modal fade" id="modalUpdate_${l.idNhaXuatBan}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/nha-xuat-ban/viewUpdate?id=${l.idNhaXuatBan}"
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDelte_${l.idNhaXuatBan}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button> <!-- Modal delete -->
                                        <div class="modal fade" id="modalDelte_${l.idNhaXuatBan}"
                                             data-bs-backdrop="static" data-bs-keyboard="false"
                                             tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/nha-xuat-ban/delete?id=${l.idNhaXuatBan}"
