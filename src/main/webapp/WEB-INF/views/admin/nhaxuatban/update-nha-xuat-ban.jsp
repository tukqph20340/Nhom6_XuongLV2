        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/nha-xuat-ban/update" method="post">
                        <input type="hidden" class="form-control" name="id" value="${detail.idNhaXuatBan}"/>
                        <div class="row">
                            <div class="col-12">
                                <label>Tên</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="radio"   value="0" name="trangThai"  ${detail.trangThai==0?"checked":""} />Ngưng Hoạt Động
                                <input type="radio"   value="1" name="trangThai"  ${detail.trangThai==1?"checked":""} />Vẫn Còn Hoạt Động
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
