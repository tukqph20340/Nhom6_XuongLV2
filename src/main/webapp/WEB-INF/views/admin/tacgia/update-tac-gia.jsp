        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/tac-gia/update" method="post">
                        <input type="hidden" class="form-control" name="id" value="${detail.idTacGia}"/>
                        <div class="row">
                            <div class="col-12">
                                <label>Họ Và Tên</label>
                                <input type="text" class="form-control" name="hoVaTen" value="${detail.hoVaTen}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
