                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/admin/tai-khoan/add" method="post">
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="ntc"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                    ...
                    <div class="table-responsive mt-5" style="overflow-x: auto">
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${listTk}" var="l">
                                <tr>
                                    <td>TK${l.idTaiKhoan}</td>
                                    <td>${l.usename}</td>
                                    <td>${l.password}</td>
                                    <td>${l.email}</td>
                                    <td>${l.sdt}</td>
                                    <td>${l.nguoiTruyCap}</td>

                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalUpdate_${l.idTaiKhoan}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button> <!-- Modal update -->
                                        <div class="modal fade" id="modalUpdate_${l.idTaiKhoan}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        <p>Warning : Bạn Có Muốn Sửa Tài Khoản Không !</p>
                                                        <a role="button"
                                                           href="/admin/tai-khoan/viewUpdate?id=${l.idTaiKhoan}"
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDelte_${l.idTaiKhoan}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button> <!-- Modal delete -->
                                        <div class="modal fade" id="modalDelte_${l.idTaiKhoan}"
                                             data-bs-backdrop="static" data-bs-keyboard="false"
                                             tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/tai-khoan/delete?id=${l.idTaiKhoan}"
