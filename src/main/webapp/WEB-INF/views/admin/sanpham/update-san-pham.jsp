            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/san-pham/update" method="post">
                        <div class="row">
                            <div class="col-12">
                                <input type="hidden" class="form-control" name="id" value="${detail.idSach}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <select name="tenNhaCungCap">
                                    <c:forEach items="${listNCC}" var="l">
                                        <option value="${l.idNhaCungCap}" ${detail.nhaCungCap.idNhaCungCap==l.idNhaCungCap?"selected":""} >${l.ten}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="tenNhaXuatBan">
                                    <c:forEach items="${listNXB}" var="l">
                                        <option value="${l.idNhaXuatBan}" ${detail.nhaXuatBan.idNhaXuatBan==l.idNhaXuatBan?"selected":""}>${l.ten}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="tenTacGia">
                                    <c:forEach items="${listTG}" var="l">
                                        <option value="${l.idTacGia}" ${detail.tacGia.idTacGia==l.idTacGia?"selected":""}>${l.hoVaTen}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-8">
                                ...
                                <select name="theLoai">
                                    <c:forEach items="${listTl}" var="l">
                                        <option value="${l.idTheLoai}" ${detail.theLoai.idTheLoai==l.idTheLoai?"selected":""}>${l.ten}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label>Tiêu Đề</label>
                                <input type="text" class="form-control" name="tieuDe" value="${detail.tieuDe}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
